...
![Rackflow Editor Mode](../../../assets/images/rackflowEditor.png)
...
1. Open via Filemenu the 'New' ![new model](../../../assets/images/new.png)
2. Enter a name, for example 'first simulation'
3. Now place some conveyor with the mouse inside the editor Creators are light gray and destroyers are dark gray.![conveyors](../../../assets/images/conveyor.png)
The next picture has one creator, two normal conveyors, one horizontal conveyor and a destroyer.  ![example conveyors](../../../assets/images/exampleWithoutLinks.png) 
4. Switch over to the Linking Mode![linking mode](../../../assets/images/linkingMode.png) to connect the elements and select each conveyor element in the direction of the material flow. Creator is the first element to select. ![example conveyors with links](../../../assets/images/exampleWithLinks.png) 
5. Save the model with clicking on the floppydisc symbol (orange) at the top left corner![save](../../../assets/images/save.png) 
...
The Simulation Mode is controlled by the Simulation Panel in the down right corner.![Simulation Panel](../../../assets/images/simulationPanel.png) 
